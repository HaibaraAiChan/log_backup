...
from stage2_GNN import FP16_DeepSpeedZeroOptimizer_GNN
...
from deepspeed.runtime.utils import ensure_directory_exists
...
class DeepSpeedEngine_GNN(Module):
    ...
    def __init__(self,
                 ...
                 collate_fn=None,
                 config_params=None):
        super(DeepSpeedEngine_GNN, self).__init__()
...
##################################################################3
    ...
    def _configure_zero_optimizer(self, optimizer):
        ...
        if zero_stage == ZERO_OPTIMIZATION_OPTIMIZER_STATES:
            ...
            optimizer = FP16_DeepSpeedZeroOptimizer_GNN(
                optimizer,
                timers=self.timers,
                static_loss_scale=self.loss_scale(),
                dynamic_loss_scale=self.dynamic_loss_scale(),
